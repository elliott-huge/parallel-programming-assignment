...
// only here as a keepsake, of sorts
		...
		while (stepCounter < stepLimit) {
			...
			if (stepCounter % 2)
			{
				// calculate sums kernel
					...
					// a normal integer?
					// additionally, should padding be added where array deviates from
					// the expected size?
...
/*
		...
		// TODO make this general structure into functions that take the necessary parameters
